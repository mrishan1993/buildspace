...
contract Domains is ERC721URIStorage { 
    ...
    constructor (string memory _tld) payable ERC721("Batman Name Service", "BNS") {
        tld = _tld;
    ...
    function register (string calldata name) public payable {
        ...
        console.log("Registering %s.%s on the contract with the token Id %d", name, tld, newRecordID);
